...
- After pairing the ESP32 to your phone, in Serial Bluetooth Terminal:
     ...
     - "A" triggers RGB
     - Case-insensitive. With macros, you only need to push a button (see [`Serial-Bluetooth-Terminal-App-With-Macros.jpg`](Serial-Bluetooth-Terminal-App-With-Macros.jpg))
